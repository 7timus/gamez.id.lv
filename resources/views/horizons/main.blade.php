...
<head>
   ...
   {{-- <script src="{{ url('/') }}/horizons/js/jquery.min.js"></script>
    <script src="{{ url('/') }}/horizons/js/jquery.dropotron.min.js"></script>
    <script src="{{ url('/') }}/horizons/js/skel.min.js"></script>
    <script src="{{ url('/') }}/horizons/js/skel-layers.min.js"></script>
    <script src="{{ url('/') }}/horizons/js/init.js"></script>--}}
{{--
        <link rel="stylesheet" href="{{ url('/') }}/horizons/css/skel.css" />
--}}




    <link rel="stylesheet" href="{{ url('/') }}/horizons/css/style.css" />
</head>
...
<div id="header">
    <div class="container">
        <!-- Logo -->
        <h1><a href="#" id="logo">Gaujmaliete</a></h1>
        <!-- Nav -->
        <nav id="nav">
            <ul>
                <li><a href="#">Menu</a></li>
